 ...
 */
	...
	enterData: function enterData() {
		...
		var now = new Date();
		var date = this.formatTime(now.getHours()) + ':' + this.formatTime(now.getMinutes()) + ':' + this.formatTime(now.getSeconds());
		var obj = 'number=' + this.Number + '&name=' + this.Name + '&hours=' + this.Hours + '&date=' + date;
